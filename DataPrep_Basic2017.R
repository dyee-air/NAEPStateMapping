...
(function() {
  ...
  st17_m <- read_stata("R:/project/State Mapping/Grade-level Estimate/statedata/sy1617state_mth.dta")
  st17_r <- read_stata("R:/project/State Mapping/Grade-level Estimate/statedata/sy1617state_rla.dta")
  st17_m$subj = 'M'
  st17_r$subj = 'R'
  st_dta <- rbind(st17_m, st17_r)
  # Convert numbers
