...
(function() {
  ...
  st15_m <- read_stata("R:/project/State Mapping/Grade-level Estimate/statedata/sy1415state_mth.dta")
  st15_r <- read_stata("R:/project/State Mapping/Grade-level Estimate/statedata/sy1415state_rla.dta")
  st15_m$subj = 'M'
  st15_r$subj = 'R'
  st_dta <- rbind(st15_m, st15_r)
  # Convert numbers
...
NAEP_PATHS <- list(
  "M4" = "R:/data/NAEP/Math/2015/Y46MAT/Data/M46NT1AT.dat",
  "M8" = "R:/data/NAEP/Math/2015/Y46MAT/Data/M46NT2AT.dat",
  "R4" = "R:/data/NAEP/Reading/2015/Y46RED/Data/R46NT1AT.dat",
  "R8" = "R:/data/NAEP/Reading/2015/Y46RED/Data/R46NT2AT.dat"
)
